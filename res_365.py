...
def resnet18_place(pretrained=False, **kwargs):
...
if __name__ == '__main__':
    ...
    resnet18.fc.out_features = 365
    print(resnet18.fc.out_features)
    """

    modelfile = "/mnt/sfshare/wideresnet18_places365.pth.tar"
    model = resnet18_place(num_classes=365)
